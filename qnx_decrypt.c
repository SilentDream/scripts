/*Code taken from http://www.securityfocus.com/data/vulnerabilities/exploits/decrypt-qnx.c.
Thanks to PerennialRequiem for modifying this to add printf() and main() function, making it functional.*/
